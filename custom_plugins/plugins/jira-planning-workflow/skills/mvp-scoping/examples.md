...
MVP Scope (Do this - as Jira Subtasks):
...
├── YES → Include in MVP (create Subtask)
└── NO → Is it a "nice to have"?
    ├── YES → Defer to future Story
...
When deferring features, document them in the Story:

```
h2. Deferred for Future Iterations

h3. Phase 2 (After MVP validation)
* Password reset flow
* OAuth integration (Google)
* Remember me functionality

h3. Phase 3 (Based on user feedback)
* Two-factor authentication
* Session management UI
* Login analytics

h3. Maybe Later (Low priority)

...
## Example: Using execute-issue-graphite Agent

```
User: "Implement LIN-123 as a stacked PR"

The execute-issue-graphite agent will:
1. Read sub-issue details from Linear
2. Create a stacked branch for the work
3. Implement the sub-issue
